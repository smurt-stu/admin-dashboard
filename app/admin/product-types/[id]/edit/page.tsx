...
export default function EditProductTypePage() {
  ...
  const loadProductType = async () => {
    try {
      ...
      const data = await ProductTypeService.getProductType(productTypeId);
      setProductType(data);
      
      // تحويل البيانات إلى نموذج التحرير
      setFormData({
        name: data.name || '',
        display_name: {
          ar: typeof data.display_name === 'string' ? data.display_name : data.display_name?.ar || '',
          en: typeof data.display_name === 'string' ? data.display_name : data.display_name?.en || ''
        },
        description: data.description || '',
        icon: data.icon || 'ri-box-line',
      ...
      setError(`فشل في تحميل نوع المنتج: ${err.message}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await ProductTypeService.updateProductType(productTypeId, productTypeData);
      ...
      setError(`فشل في تحديث نوع المنتج: ${errorMessage}`);
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-800 mt-2">تعديل نوع المنتج</h1>
          <p className="text-gray-600 mt-1">تعديل إعدادات نوع المنتج والحقول المخصصة</p>
        </div>
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex">
            ...
            <div className="mr-3">
              <h3 className="text-sm font-medium text-red-800">خطأ في تحديث نوع المنتج</h3>
        ...
        <div>
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 sticky top-6">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <h4 className="text-sm font-medium text-gray-900 mb-3">معلومات نوع المنتج</h4>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• احفظ التغييرات بانتظام</li>
                <li>• تأكد من صحة الحقول المخصصة</li>
                <li>• اختبر النوع بعد التعديل</li>
                <li>• راجع المنتجات المرتبطة</li>
              </ul>
            </div>
          </div>
        </div>
